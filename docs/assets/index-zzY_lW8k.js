...
`,ie=()=>{var i,o;if(localStorage.getItem("obora_cookie_consent"))return;const e=document.getElementById("cookie-banner");if(!e)return;setTimeout(()=>e.classList.add("cookie-banner--visible"),1400);const t=()=>{e.classList.remove("cookie-banner--visible"),setTimeout(()=>e.remove(),400)};(i=document.getElementById("cookie-accept"))==null||i.addEventListener("click",()=>{localStorage.setItem("obora_cookie_consent","accepted"),t()}),(o=document.getElementById("cookie-reject"))==null||o.addEventListener("click",()=>{localStorage.setItem("obora_cookie_consent","rejected"),t()})},se=`
  ...
  <p>Administratorem Twoich danych osobowych jest <strong>OBORA Serwis Rowerowy</strong> z siedzibą w Warszawie, adres e-mail: <a href="mailto:kontakt@oborabikes.pl">kontakt@oborabikes.pl</a>, telefon: +48 123 456 789.</p>
  <p><em>Nota: Uzupełnij pełny adres siedziby i numer NIP przed wdrożeniem produkcyjnym.</em></p>
  ...
  <h4>Google Maps</h4>
  <p>Gdy klikniesz „Załaduj mapę", serwis Google Maps może ustawiać własne pliki cookie oraz przetwarzać Twój adres IP. Dzieje się to wyłącznie na Twoje żądanie. Administratorem tych danych jest Google LLC. Szczegóły: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">policies.google.com/privacy</a>.</p>
  ...
  <p>Twoje dane mogą być przekazywane: dostawcy hostingu (GitHub Pages / Fastly), Google LLC (tylko w przypadku załadowania mapy – siedziba w USA, transfer na podstawie Standardowych Klauzul Umownych).</p>
  ...
  <p>Aby skorzystać z powyższych praw, skontaktuj się z nami pod adresem: <a href="mailto:kontakt@oborabikes.pl">kontakt@oborabikes.pl</a>.</p>

  <h3>6. Pliki cookie</h3>
  <p>Strona samodzielnie hostuje wszystkie czcionki i zasoby — nie wysyłamy żadnych danych do zewnętrznych serwerów przy samym wejściu na stronę. Pliki cookie stron trzecich mogą pojawić się wyłącznie gdy użytkownik zdecyduje się załadować mapę Google Maps.</p>
...
`,ae=()=>{const e=document.getElementById("privacy-modal"),t=document.getElementById("privacy-backdrop"),i=document.getElementById("privacy-close"),o=()=>e==null?void 0:e.classList.add("privacy-modal--open"),s=()=>e==null?void 0:e.classList.remove("privacy-modal--open");i==null||i.addEventListener("click",s),t==null||t.addEventListener("click",s),document.addEventListener("keydown",n=>{n.key==="Escape"&&s()}),document.addEventListener("click",n=>{n.target.closest('[data-privacy="open"]')&&(n.preventDefault(),o())})},N=document.querySelector("#app");N&&(N.innerHTML=`
    ...
    ${oe()}
    ${te()}
  `,V(),ae(),ie());document.addEventListener("click",e=>{const t=e.target.closest("[data-scroll]");if(!t)return;e.preventDefault();const i=t.getAttribute("data-scroll");if(!i)return;const o=document.getElementById(i);if(o){const s=o.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:s,behavior:"smooth"})}});document.addEventListener("click",e=>{if(e.target.id!=="load-map-btn")return;const t=document.getElementById("map-consent");if(!t)return;const i=t.closest(".contact-map-wrapper");i&&(i.innerHTML=`
    <iframe
  ...
  `)});new U({autoRaf:!0,smoothWheel:!0});G();
